...
def index():
    ...
    Label(index_ui, text='Welcome to E-Library', font='Helvetica 18 ', fg='white', bg='#34383C').place(x=50, y=230)
    Label(index_ui, text='Add / Remove / update and view the books using this interactive application', font='Helvetica 10', fg='#0D90CB', bg='#34383C').place(x=50, y=290)
    ...
    Label(index_ui, image=logo,borderwidth=0).place(x=570,y=120)
    ...
    signup_button = Button(index_ui, borderwidth=0,bg='#1A2E39', command=dash.create_acc)
    signup_button_bg = PhotoImage(file="images/signup_button.GIF")
    signup_button.config(image=signup_button_bg)
    signup_button.place(x=640 , y=410)
